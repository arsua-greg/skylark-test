...
function PrivacyPolicyPage() {
  return (
    <div className="mx-auto max-w-[1120px] px-5 mt-16 pb-72">
      ...
      <div className="mt-7">
        <p className="text-lg font-bold">著作権</p>
      ...
      <div className="mt-7">
        <p className="text-lg font-bold">商標</p>
        <p className="md:text-sm text-[13px] md:mt-4 mt-5">
      ...
      <div className="mt-7">
        <p className="text-lg font-bold">免責事項</p>
        <p className="md:text-sm text-[13px] md:mt-4 mt-5">
