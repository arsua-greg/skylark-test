    ...
    try {
      ...
      if (response.ok) {
        ...
        if (emailRes.ok) {
          ...
          console.log("Email not Sent Error", emailRes.status);
        }

        setBookingCode(bookingCode);
        setIsReserved(true);
        console.log("Booked", response.status);
      } else {
        setErrorPost(true);
        console.log("Error Booking", response.status);
      }
    } catch (err) {
      console.log(err);
      setErrorPost(true);
